...
public class T2ElectroShovelItem extends CustomShovelItem {
    public T2ElectroShovelItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
