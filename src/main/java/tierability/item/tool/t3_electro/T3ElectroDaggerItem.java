...
public class T3ElectroDaggerItem extends BaseDaggerItem {
    public T3ElectroDaggerItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
