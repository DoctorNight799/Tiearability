...
public class T3ElectroPickaxeItem extends CustomPickaxeItem {
    public T3ElectroPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
