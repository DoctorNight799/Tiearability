...
public class T3ElectroAxeItem extends CustomAxeItem {
    public T3ElectroAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
