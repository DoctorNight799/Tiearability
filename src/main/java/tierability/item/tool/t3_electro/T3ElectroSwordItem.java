...
public class T3ElectroSwordItem extends CustomSwordItem {
    public T3ElectroSwordItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
