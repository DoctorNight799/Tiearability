...
public class T1NatureSpearItem extends BaseSpearItem {
    public T1NatureSpearItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, float attackRange, Settings settings) {
