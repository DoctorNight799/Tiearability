...
public class NatureSpearItem extends BaseSpearItem{
    public NatureSpearItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, float attackRange, Settings settings) {
