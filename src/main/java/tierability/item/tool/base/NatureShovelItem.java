...
public class NatureShovelItem extends BaseShovelItem {
    public NatureShovelItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
