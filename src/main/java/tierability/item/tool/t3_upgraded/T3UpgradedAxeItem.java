...
public class T3UpgradedAxeItem extends CustomAxeItem {
    public T3UpgradedAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
