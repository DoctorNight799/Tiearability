...
public class T1ElectroAxeItem extends CustomAxeItem {
    public T1ElectroAxeItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
