...
public class T3FlameDaggerItem extends BaseDaggerItem {
    public T3FlameDaggerItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
