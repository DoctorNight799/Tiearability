...
public class T3FlamePickaxeItem extends CustomPickaxeItem {
    public T3FlamePickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
