...
public class T3FlameShovelItem extends CustomShovelItem {
    public T3FlameShovelItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
